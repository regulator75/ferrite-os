...
obj/kernel_combined.bin: obj/kernel.o obj/kernel_cpp.o
	/usr/local/x86_64elfgcc/bin/x86_64-elf-ld -o obj/kernel_combined.bin -Ttext 0x1000 --oformat binary obj/kernel.o obj/kernel_cpp.o